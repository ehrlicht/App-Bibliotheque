...
public class DataInitializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        if (bs.listAll().isEmpty()) {
            ...
            bs.save(new Book("La Divine Comédie", "Dante Alighieri", "", Year.of(1472)));
            bs.save(new Book("Crime et Chatiment", "Fiodor Dostoïevski", "Rousky vestnik", Year.of(1866)));
            bs.save(new Book("Medée", "Euripide", "", Year.of(-431)));
            ...
            bs.save(new Book("Les Misérables", "Victor Hugo", "A. Lacroix, Verboeckhoven & Cie.", Year.of(1862)));
